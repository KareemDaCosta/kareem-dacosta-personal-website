    ...
    const experiences = [
        {
            ...
            <br />
            <span className="underline">Website Features:</span> Custom-built live and paginated chat and notifications systems created with Sockets API; a paginated, ranked, dynamically fetched party query system; background thread prefetching; responsive web design; custom party images; persistent login; recoil state management.
            <br />
